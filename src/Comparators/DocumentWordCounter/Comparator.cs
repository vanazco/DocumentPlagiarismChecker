...
namespace DocumentPlagiarismChecker.Comparators.DocumentWordCounter
{
    ...
    {  
        /// <summary>
        /// Crea una nova instancia per la clase "Comparator".
        /// </summary>
        /// <param name="fileLeftPath">La part esquerra de la ruta del fitxer</param>
        /// <param name="fileRightPath">La part dreta de la ruta del fitxer</param>
        /// <returns></returns>
        ...
        /// <summary>
        /// Compta quantes paraules i quantes vegades apareix a cada document i comprova el percentatge de concordança.   
        /// </summary>
