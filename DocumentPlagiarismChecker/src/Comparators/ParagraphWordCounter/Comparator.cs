...
namespace DocumentPlagiarismChecker.Comparators.ParagraphWordCounter
{
    ...
    {  
        ...
        /// </summary>
        /// <param name="doc">Documento que será comparado con la muestra.</param>
        private void ExcludeSampleMatches(Document doc){
             if(this.Sample != null){
                //Acorde a la mejora del rendimiento, todos los párrafos de muestra serán excluidos desde el inicio en ambos documentos (Solo las coincidencias exactas).
